...
2. Installing the call Package

A. Change to the directory that contains the file setup.py and the subdirectory call. If 
...
3. Using the call Package

The call package is on your Python path. To import it into a Python script or session, 
execute:
